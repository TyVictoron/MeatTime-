...
class MeatLocker: NSObject
{
    ...
    var ChickenCuts : [String] = ["General","Breast", "Legs", "Wings","Thighs","Whole"]
    ...
    var PorkCuts : [String] = ["General","Chops", "Bacon", "Ribs", "Loin", "Shoulder", "Ham"]
    ...
    var selectedMeatTemp : String = "155"
}
